...
class VehicleIssueReported extends BaseNotification
{
    use Queueable;
    ...
    public function toArray(object $notifiable): array
    {
        ...
        return [
            'title' => "New Vehicle Issue Reported: {$severity}",
            'message' => "{$driverName} reported a {$severity} issue for {$vehicleInfo}: {$this->vehicleReport->title}",
            'type' => Notification::VEHICLE_ISSUE_REPORTED,
