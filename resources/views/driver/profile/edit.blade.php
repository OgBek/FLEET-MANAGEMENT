    ...
    <div class="bg-white rounded-lg shadow overflow-hidden">
        <div class="p-6 space-y-6">
            ...
            <section>
                ...
                <form method="post" action="{{ route('driver.profile.update') }}" class="mt-6 space-y-6" enctype="multipart/form-data" id="profileForm">
                    @csrf
                    @method('patch')
            ...
            <section class="mt-10 pt-10 border-t border-gray-200">
                ...
                <form method="post" action="{{ route('driver.profile.update') }}" class="mt-6 space-y-6" id="passwordForm">
                    @csrf
                    @method('patch')
