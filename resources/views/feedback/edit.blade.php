                ...
                <form action="{{ route('feedback.update', $feedback) }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <select name="type" id="type" required 
                            ...
                            <option value="booking" {{ old('type', $feedback->type) == 'booking' ? 'selected' : '' }}>Booking Experience</option>
                            <option value="service" {{ old('type', $feedback->type) == 'service' ? 'selected' : '' }}>Service Quality</option>
                            <option value="general" {{ old('type', $feedback->type) == 'general' ? 'selected' : '' }}>General Feedback</option>
                        </select>
                        @error('type')
                    ...
                    <div id="bookingField" style="display: none;">
                        ...
                        <select name="booking_id" id="booking_id"
                            ...
                            @foreach($bookings as $booking)
                                <option value="{{ $booking->id }}" {{ old('booking_id', $feedback->booking_id) == $booking->id ? 'selected' : '' }}>
