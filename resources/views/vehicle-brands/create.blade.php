            ...
            <form action="{{ route('admin.vehicle-brands.store') }}" method="POST">
                ...
                <div class="space-y-6">
                    ...
                    <div class="flex items-center justify-end space-x-3">
                        <a href="{{ route('admin.vehicle-brands.index') }}" class="inline-flex items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                            Cancel
                        </a>
